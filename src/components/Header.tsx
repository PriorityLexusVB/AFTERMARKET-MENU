    ...
    <header className="bg-lux-bg1/80 backdrop-blur-sm py-4 border-b border-lux-border/60 sticky top-0 z-header">
      <div className="container mx-auto px-4 sm:px-8 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="text-center sm:text-left">
          <h1 className="text-3xl sm:text-4xl font-bold tracking-widest font-teko text-lux-textStrong">
            PRIORITY <span className="text-lux-textMuted">LEXUS</span>
          </h1>
          <p className="text-sm text-lux-textMuted tracking-widest">
            VIRGINIA BEACH
          </p>
        </div>
            ...
            <>
              ...
              {!isDemoMode && (
                <>
                  ...
                  <p className="text-lg text-lux-textMuted font-light font-teko tracking-widest hidden md:block">
                    PRIORITIES FOR LIFE
                  </p>
                  <button
