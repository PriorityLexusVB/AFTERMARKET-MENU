...
- 2026-02-04: npm run build -> build succeeded; missing VITE*FIREBASE*\* warns and uses mock fallback.
...
- 2026-02-08: npm run build -> succeeded; mock fallback for missing VITE*FIREBASE*\*.
