...
**Important:** This approach passes environment variables to the buildpack build process via `--set-build-env-vars`, ensuring Vite has access to them during compilation.
...
3. **Deploy to Cloud Run**
   ...
   gcloud run deploy aftermarket-menu \
     ...
     --region us-west1 \
     --allow-unauthenticated \
     --set-build-env-vars="VITE_FIREBASE_API_KEY=AIza...,VITE_FIREBASE_AUTH_DOMAIN=your-app.firebaseapp.com,VITE_FIREBASE_PROJECT_ID=your-project-id,VITE_FIREBASE_STORAGE_BUCKET=your-app.appspot.com,VITE_FIREBASE_MESSAGING_SENDER_ID=123456789,VITE_FIREBASE_APP_ID=1:123456789:web:abc123"
   ```
