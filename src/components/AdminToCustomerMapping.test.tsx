...
describe("Admin to Customer Menu Mapping", () => {
  ...
  describe("AND/OR Connector Rendering", () => {
    it("should render AND connector between features by default", () => {
      ...
      // AND connectors are implicit (no text label). Assert connector structure instead.
    ...
    it("should render OR connector when feature has OR connector type", () => {
      ...
      // OR dividers should appear for features with OR connector
      // OR divider should appear before feature2; no AND divider in a 2-feature list.
