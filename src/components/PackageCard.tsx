...
export const PackageCard: React.FC<PackageCardProps> = ({ packageInfo, allFeaturesForDisplay: _allFeaturesForDisplay, isSelected, onSelect, onViewFeature, className = '', style, isCompact = false }) => {
  ...
  return (
    ...
    `}
      style={style}
    >
      <div className={`${isCompact ? 'am-package-header-compact' : 'am-package-header'} flex items-start justify-between`}>
      ...
      <div className="relative flex-1 flex flex-col min-h-0 overflow-hidden">
        <div className={`${isCompact ? 'am-package-body-compact' : 'am-package-body'} space-y-3 flex-1 overflow-hidden`}>
      ...
      <div className={`space-y-3 mt-auto ${isCompact ? 'am-package-footer-compact' : 'am-package-footer'}`}>
