...
Guardrails and implementation notes: see `docs/IPAD_PAPER_MODE_GUARDRAILS.md`.
...
- Keep the page non-scroll.
- Prefer pagination/clamping/spacing adjustments.
- Only as a last resort, allow scroll inside a contained sub-panel (never the entire page).
