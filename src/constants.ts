// All data arrays have been removed and are now fetched from the Firebase/Firestore backend.
...
export const MAIN_PAGE_ADDON_IDS = ["suntek-standard", "screen-defender", "evernew"];
